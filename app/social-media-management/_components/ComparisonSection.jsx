...
const KINETIC = [
  "Dedicated content strategist, not a shared team",
  "Monthly calendar approved by you before publishing",
  "Design, copy & scheduling included in one retainer",
  "Transparent pricing before the first call",
  "Strategy built on your actual audience data",
];

const TYPICAL = [
  "One freelancer juggling 15+ clients",
  "\"We'll post when ready\" content delivery",
  "Design and copy billed separately as add-ons",
  "Pricing revealed only after a long sales call",
  "Generic content templates reused across clients",
];
      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-10">
        <div className="text-center mb-14">
          ...
          <h2 className="text-3xl lg:text-4xl font-extrabold text-white tracking-tight mt-2">
            What "managing your social" actually means
          </h2>
