...
export default function ContactSection() {
  ...
  const validatePhone = (v) => {
    return /^[0-9\+\-\s\(\)]{7,15}$/.test(v.trim()); // Broadened for international since using $
  };
      ...
      const { error } = await supabase.from('leads').insert([
        {
          ...
          website_type: formData.app_type, // reusing website_type column for app type
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            <MotionWrapper>
              ...
              <p className="text-gray-400 text-lg leading-relaxed mb-8">
                Fill out the form to request a free consultation. Our technical experts will analyze your requirements and get back to you with a tailor-made proposal.
              </p>
          ...
          <div className="lg:col-span-7 w-full">
            <div className="rounded-3xl border border-white/8 bg-[#0F0F18] p-6 sm:p-10 backdrop-blur-xl shadow-2xl relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold text-white mb-6">Let's Discuss Your App Idea</h3>
              ...
              {status === 'success' ? (
                <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-8 text-center space-y-4">
                  ...
                  <p className="text-sm text-gray-400">Thank you! Our technical team will contact you shortly.</p>
                  <button
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-bold uppercase tracking-wider text-gray-400 mb-1.5" htmlFor="app_type">
                        App Type
                      </label>
                      <select
                        id="app_type"
                      ...
                      >
                        ...
                        <option value="Enterprise App">Enterprise App</option>
                        <option value="On-Demand App">On-Demand App</option>
