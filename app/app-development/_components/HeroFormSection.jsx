...
import { ArrowRight, Star, Check, Zap, Shield, Smartphone, Headphones, Phone } from 'lucide-react';
    ...
    try {
      const res = await fetch('/api/leads', {
        ...
        body: JSON.stringify({
          ...
          company: formData.company, service: 'App Development',
          website_type: formData.app_type, budget: formData.budget,
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-8 sm:py-12 lg:py-0 flex-1 flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_480px] xl:grid-cols-[1fr_520px] gap-8 xl:gap-20 items-center w-full lg:py-16">
          ...
          <div className="text-left order-2 lg:order-1">
            ...
            >
              We design and develop scalable, high-performance Android, iOS, and cross-platform
              apps to help your business grow, automate operations and reach more customers.
            </motion.p>
            ...
            <div className="relative">
              ...
              <div className="relative rounded-2xl border border-white/10 bg-[#0C0C15]/95 backdrop-blur-2xl overflow-hidden shadow-[0_32px_80px_rgba(0,0,0,0.6)]">
                ...
                <div className="p-6 sm:p-7">
                  ...
                  <div className="mb-5">
                    <h2 className="text-[1.35rem] font-bold text-white">Get a Free App Consultation</h2>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-3.5">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="block text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-1.5" htmlFor="ad-name">
                          Full Name <span className="text-amber-500">*</span>
                        </label>
                        <input id="ad-name" type="text" placeholder="John Doe"
                      ...
                      <div>
                        <label className="block text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-1.5" htmlFor="ad-email">
                          Email <span className="text-amber-500">*</span>
                        </label>
                        <input id="ad-email" type="email" placeholder="you@example.com"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="block text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-1.5" htmlFor="ad-phone">
                          Phone <span className="text-amber-500">*</span>
                        </label>
                        <input id="ad-phone" type="tel" placeholder="9876543210"
                          value={formData.phone} onChange={e => setFormData({...formData, phone: e.target.value.replace(/\D/g,'').slice(0,10)})}
                          className="w-full rounded-lg border border-white/8 bg-white/[0.04] px-3.5 py-2.5 text-sm text-white placeholder-gray-700 outline-none focus:border-amber-400/60 focus:ring-1 focus:ring-amber-400/25 transition-all duration-200"
                          required />
                      </div>
                      <div>
                        <label className="block text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-1.5" htmlFor="ad-company">
                          Company
                        </label>
                        <input id="ad-company" type="text" placeholder="Acme Corp"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="block text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-1.5" htmlFor="ad-type">
                          App Type
                        </label>
                        <select id="ad-type" value={formData.app_type} onChange={e => setFormData({...formData, app_type: e.target.value})}
                          ...
                          <option>Other App</option>
                        </select>
                      </div>
                      <div>
                        <label className="block text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-1.5" htmlFor="ad-budget">
                          Budget
                        </label>
                        <select id="ad-budget" value={formData.budget} onChange={e => setFormData({...formData, budget: e.target.value})}
                          className="w-full rounded-lg border border-white/8 bg-[#111120] px-3.5 py-2.5 text-sm text-white outline-none focus:border-amber-400/60 focus:ring-1 focus:ring-amber-400/25 transition-all appearance-none cursor-pointer">
                    ...
                    {/* Requirements */}
                    <div>
                      <label className="block text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-1.5" htmlFor="ad-req">
                        Project Requirements
                      </label>
                      <textarea id="ad-req" rows={2} placeholder="Describe your app idea (optional)..."
                    ...
                    >
                      ...
                      <span className="relative flex items-center justify-center gap-2">
                        {status === 'submitting' ? (
                          ...
                          <>🚀 Get Free App Consultation <ArrowRight className="h-4 w-4 ml-0.5 transition-transform duration-200 group-hover:translate-x-1" /></>
                        )}
                      </span>
                    </button>
