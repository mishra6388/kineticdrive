...
const technologies = [
  { name: 'Swift', category: 'iOS', icon: '', color: 'from-orange-400 to-red-400', bg: '#0d1117' },
  { name: 'Objective-C', category: 'iOS', icon: 'C', color: 'from-blue-400 to-sky-500', bg: '#0d1117' },
  { name: 'Kotlin', category: 'Android', icon: 'K', color: 'from-purple-400 to-violet-500', bg: '#0d1117' },
  { name: 'Java', category: 'Android', icon: '☕', color: 'from-orange-400 to-amber-500', bg: '#0d1117' },
  { name: 'React Native', category: 'Cross-Platform', icon: '⚛', color: 'from-cyan-300 to-blue-400', bg: '#0d1117' },
  { name: 'Flutter', category: 'Cross-Platform', icon: 'F', color: 'from-sky-400 to-cyan-400', bg: '#0d1117' },
  { name: 'Node.js', category: 'Backend', icon: '⬡', color: 'from-green-400 to-emerald-500', bg: '#0d1117' },
  { name: 'Python', category: 'Backend', icon: '🐍', color: 'from-yellow-400 to-blue-500', bg: '#0d1117' },
  { name: 'Firebase', category: 'Backend', icon: '🔥', color: 'from-orange-400 to-yellow-400', bg: '#0d1117' },
  { name: 'PostgreSQL', category: 'Database', icon: '🐘', color: 'from-blue-400 to-indigo-500', bg: '#0d1117' },
];

const categoryColors = {
  iOS: 'text-sky-400 border-sky-400/20 bg-sky-400/8',
  Android: 'text-emerald-400 border-emerald-400/20 bg-emerald-400/8',
  'Cross-Platform': 'text-violet-400 border-violet-400/20 bg-violet-400/8',
  Backend: 'text-cyan-400 border-cyan-400/20 bg-cyan-400/8',
  Database: 'text-blue-400 border-blue-400/20 bg-blue-400/8',
};
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <MotionWrapper className="text-center mt-10" delay={0.2}>
          <p className="text-sm text-gray-600">
            Not sure which tech is right for your app?{' '}
