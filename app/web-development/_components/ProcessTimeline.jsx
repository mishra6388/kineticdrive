...
const steps = [
  {
    ...
    icon: MessageSquare,
    title: 'Consultation',
    desc: 'We start with a deep-dive discovery call to understand your business goals, target audience, and project requirements.',
  ...
  },
  {
    ...
    icon: ClipboardList,
    title: 'Planning',
    desc: 'We create a detailed project plan including sitemap, technical architecture, timeline, and milestone-based delivery schedule.',
  ...
  },
  {
    ...
    icon: Figma,
    title: 'UI Design',
    desc: 'Our designers craft pixel-perfect mockups aligned with your brand identity. You review and approve every screen before development.',
  ...
  },
  {
    ...
    icon: Code2,
    title: 'Development',
    desc: 'Clean, scalable, and maintainable code built with modern technologies. Regular progress updates keep you in the loop throughout.',
  ...
  },
  {
    ...
    icon: TestTube,
    title: 'Testing',
    desc: 'Rigorous QA across all devices and browsers — performance, security, functionality, and SEO checks before any code goes live.',
  ...
  },
  {
    ...
    icon: Rocket,
    title: 'Deployment',
    desc: 'Smooth launch on your hosting environment with zero downtime. DNS setup, SSL certificates, and final performance tuning included.',
  ...
  },
  {
    ...
    icon: Settings,
    title: 'Maintenance',
    desc: 'Ongoing support, security patches, content updates, and feature enhancements to ensure your website stays fast and relevant.',
      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        <MotionWrapper className="text-center mb-16 max-w-2xl mx-auto">
          ...
          <p className="text-gray-400 text-lg">
            ...
            live, high-performing website — stress-free.
          </p>
        </MotionWrapper>
